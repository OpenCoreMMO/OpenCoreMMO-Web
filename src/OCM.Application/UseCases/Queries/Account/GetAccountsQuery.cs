...
public class GetAccountsQuery(IAccountRepository accountRepository)
    : IRequestHandler<GetAccountsRequest, BasePagedResponseViewModel<IEnumerable<AccountResponseViewModel>>>
{
